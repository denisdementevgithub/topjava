...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime,
        ...
        Map<LocalDate, Integer> sumOfCalories = getDateCaloriesMapByCycles(meals);
    ...
    private static Map<LocalDate, Integer> getDateCaloriesMapByCycles(List<UserMeal> meals) {
        ...
        return dateCaloriesMap;
    }

    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        Map<LocalDate, Integer> sumOfCalories = getDateCaloriesMapByStream(meals);
        return meals.stream()
    ...
    private static Map<LocalDate, Integer> getDateCaloriesMapByStream(List<UserMeal> meals) {
        return meals.stream()
